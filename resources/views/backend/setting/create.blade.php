<div class="kt-portlet__body">
    <div class="row">
        <div class="form-group col-sm-2">
            ...
            <input type="text" name="website_name"  placeholder="Enter WebsiteName" class="form-control" required>
        </div>
        <div class="form-group col-sm-2">
            <label>Logo</label>
        ...
        <div class="form-group col-sm-3">
            ...
            <input type="text" name="website_email"  placeholder="Enter Website Email" class="form-control">
        </div>
        <div class="form-group col-sm-2">
            <label>Website Privacy Policy</label>
            <input type="text" name="privacy_policy"  placeholder="Enter Privacy Policy" class="form-control">
        </div>
        <div class="form-group col-sm-2">
